                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->number_adults }}</td>
                                        <td>{{ $item->number_children }}</td>
                                        <td>
                                            <a href="{{ route('admin-roomtype-edit', $item->id) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                        </td>
                                        <td>
                                            <a href="{{ route('admin-roomtype-delete', $item->id) }}" onclick="return confirm('Are you sure?')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
