		...
		<div class="equal-content-sidebar">
			...
			<div class="container">
					...
					<aside>
						...
						<div class="room-page-right-sidebar alt">
							...
							<div class="room-page-heading">
								...
								<h4>{{ $post_now->accommodation_name }}</h4>
								<p><i class="fa fa-map-marker"></i> {{ $post_now->city->city_name }}</p>
								<p> {{ $post_now->accommodation_address }}</p>

							</div>

							<div class="image">
								<img src="{{ $post_now->accommodation_img }}" alt="Top Destinations">
							</div>
				...
				<div class="content-wrapper">
					...
					{{-- form --}}
					<form method="post" action="{{ route('booking-edit-process') }}">
						@csrf
								...
								<div class="form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-sm-6 col-md-6">
											<input type="text" class="form-control mb-0" placeholder="Full Name" value="{{ $post->customer_name }}"
												name="name">
										</div>
									</div>
									{{-- address --}}
									<div class="form-group">
										...
										<div class="col-sm-6 col-md-6">
											<input type="text" class="form-control mb-0" placeholder="Adđress" value="{{ $post->customer_address }}"
												name="address">
										</div>
									</div>
									{{-- email --}}
									<div class="form-group">
										...
										<div class="col-sm-6 col-md-6">
											<input type="email" class="form-control mb-0" placeholder="Email Address" value="{{ $post->customer_email }}"
												name="email">
										</div>
									</div>
									{{-- phonenumber --}}
									<div class="form-group">
										...
										<div class="col-sm-6 col-md-6">
											<input type="text" name="phonenumber" class="form-control mb-0" placeholder="Phone Number" value="{{ $post->customer_email }}">
										</div>
									</div>
						...
						<div class="payment-congrate">
							...
							<div class="inner">
								...
								<input type="submit" class="btn" value="Edit Now">
