        ...
        <div class="container">
            ...
            <div class="content-wrapper">
                ...
                <div class="result-status">
                    ...
                    <p>We found <span class="text-primary font700">256</span> hotels with availability in <span class="text-primary font700">Paris</span>. Showing 1 - 30</p>
                ...
                <div class="hotel-item-list-wrapper mb-40">
                    ...
                    <div class="hotel-item-list">
                        <div class="image" style="background-image:url('extretion/images/top-destinations/01.jpg');"></div>
                        <div class="content">
                            <div class="heading">
                    ...
                    <div class="hotel-item-list">
                        <div class="image" style="background-image:url('extretion/images/top-destinations/02.jpg');"></div>
                        <div class="content">
                            <div class="heading">
                                <h4>Phulay Bay Resort</h4>
                                <p><span class="star-rate rated-40 mr-10"></span> <i class="fa fa-map-marker text-primary"></i> Phuket, Thailand</p>
                            </div>
                            <div class="short-info">
                                Use securing confined his shutters. Delightful as he it acceptance an solicitude discretion reasonably. Carriage we husbands advanced an perceive greatest expense on demesne ye he.
                            </div>
                    ...
                    <div class="hotel-item-list">
                        <div class="image" style="background-image:url('extretion/images/top-destinations/03.jpg');"></div>
                        <div class="content">
                            <div class="heading">
                                <h4>Hotel Metropolitan Tokyo</h4>
                                <p><span class="star-rate rated-40 mr-10"></span> <i class="fa fa-map-marker text-primary"></i> Tokyo, Japan</p>
                    ...
                    <div class="hotel-item-list">
                        <div class="image" style="background-image:url('extretion/images/top-destinations/04.jpg');"></div>
                        <div class="content">
                            <div class="heading">
                                <h4>Hotel Metropolitan Tokyo</h4>
                                <p><span class="star-rate rated-40 mr-10"></span> <i class="fa fa-map-marker text-primary"></i> Tokyo, Japan</p>
                    ...
                    <div class="hotel-item-list">
                        <div class="image" style="background-image:url('extretion/images/top-destinations/05.jpg');"></div>
                        <div class="content">
                            <div class="heading">
                                <h4>Hotel Metropolitan Tokyo</h4>
                                <p><span class="star-rate rated-40 mr-10"></span> <i class="fa fa-map-marker text-primary"></i> Tokyo, Japan</p>
                    ...
                    <div class="hotel-item-list">
                        <div class="image" style="background-image:url('extretion/images/top-destinations/06.jpg');"></div>
                        <div class="content">
                            <div class="heading">
                                <h4>Hotel Metropolitan Tokyo</h4>
                                <p><span class="star-rate rated-40 mr-10"></span> <i class="fa fa-map-marker text-primary"></i> Tokyo, Japan</p>
                    ...
                    <div class="hotel-item-list">
                        <div class="image" style="background-image:url('extretion/images/top-destinations/07.jpg');"></div>
                        <div class="content">
                            <div class="heading">
                                <h4>Hotel Metropolitan Tokyo</h4>
                                <p><span class="star-rate rated-40 mr-10"></span> <i class="fa fa-map-marker text-primary"></i> Tokyo, Japan</p>
                    ...
                    <div class="hotel-item-list">
                        <div class="image" style="background-image:url('extretion/images/top-destinations/08.jpg');"></div>
                        <div class="content">
                            <div class="heading">
                                <h4>Hotel Metropolitan Tokyo</h4>
                                <p><span class="star-rate rated-40 mr-10"></span> <i class="fa fa-map-marker text-primary"></i> Tokyo, Japan</p>
                    ...
                    <div class="hotel-item-list">
                        <div class="image" style="background-image:url('extretion/images/top-destinations/09.jpg');"></div>
                        <div class="content">
                            <div class="heading">
                                <h4>Hotel Metropolitan Tokyo</h4>
                                <p><span class="star-rate rated-40 mr-10"></span> <i class="fa fa-map-marker text-primary"></i> Tokyo, Japan</p>
