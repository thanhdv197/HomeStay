		...
		<div class="main-wrapper">
			...
			<div class="container">
				...
				<div class="confirm-summary clearfix">
					...
					<div class="image">
						<img src="{{ $post_id->post->accommodation_img }}" alt="Top Destinations">
					</div>
					<div class="heading">
						<div class="raty-wrapper sp-2 mb-5">
							<div class="star-rating-12px" data-rating-score="4"></div>
						</div>
						<h4>{{ $post_id->post->accommodation_name }}</h4>
						<p>{{ $post_id->post->accommodation_address }} - <a href="#" class="font13"><i class="fa fa-map-marker"></i> view on map</a></p>
					</div>
					<div class="content">
						...
						<div class="metro-box-wrapper equal-height">
							...
							<div class="content">
								...
								<ul class="confirm-list inverse">
									...
									<li>
										<span class="absolute">{{ $post_id->price }} VND</span> 
										<span class="font600">{{ $post_id->room_name }}:</span><br/>
										{{ $post_id->utilities }}<br/>
										<span class="font600">Room Type: </span>
										{{ $post_id->RoomType->room_type_name }}
									</li>
				...
				<div class="text-right mb-50">
					...
					<a href="{{ route('booking-confirm') }}" class="btn btn-primary btn-lg btn-icon">Confirm and Book<span class="icon"><i class="pe-7s-angle-right"></i></span></a>
