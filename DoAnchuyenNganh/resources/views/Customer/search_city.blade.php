        ...
        <div class="container">
            ...
            <div class="content-wrapper">
                ...
                <div class="result-status">
                    ...
                    <p>We found <span class="text-primary font700"></span> {{ count($postcity)}} places.</p>
                    <a href="result-map.html" class="show-on-map" style="background-image:url('');">
                        <span>
